...
Assurance는 production publication authority가 아니라 security corpus와 작은 test-local PostgreSQL로
...
- Integration fixture는 production DB procedure나 protected evidence가 아닙니다.
...
Security corpus는 policy owner tests, real DB는 fixture/catalog/query lifecycle, container는 Docker/Compose와
