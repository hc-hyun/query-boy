...
def _build_failing_app(
    ...
    *,
    ...
    monkeypatch.setattr(app_module, "PostgresMetadataStore", FakeMetadataStore)
    monkeypatch.setattr(app_module, "PostgresSourceStore", FakeSourceStore)
    monkeypatch.setattr(app_module, "_reload_sources", tracked_reload_task)
    monkeypatch.setattr(
        app_module,
        "create_mcp_server",
